...
namespace Flat4Me.Web.Boss.Controllers
{
    public abstract class BaseController : Controller
    {
        ...
        private F4MeBossSignInManager _signInManager;
        private F4MeBossUserManager _userManager;
        ...
        public F4MeBossSignInManager SignInManager
        {
            get
            {
                return _signInManager ?? HttpContext.GetOwinContext().Get<F4MeBossSignInManager>();
            }
            private set
            {
        ...
        public F4MeBossUserManager UserManager
        {
            get
            {
                return _userManager ?? HttpContext.GetOwinContext().GetUserManager<F4MeBossUserManager>();
            }
            private set
            {
                _userManager = value;
