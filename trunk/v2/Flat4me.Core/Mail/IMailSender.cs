...
namespace Flat4me.Core.Mail
{
    public interface IMailSender
    {
        ...
        void SendPlainText(IEnumerable<string> recipients, string subject, string msgbody);
        ...
        /// <param name="subject">Тема сообщения</param>
        /// <param name="msgbody">Тело сообщения</param>
        void SendPlainText(string from, IEnumerable<string> recipients, string subject, string msgbody);
        ...
        /// <param name="subject">Тема сообщения</param>
        /// <param name="msgbody">Тело сообщения</param>
        void SendHtmlText(IEnumerable<string> recipients, string subject, string msgbody);
        ...
        /// <param name="subject">Тема сообщения</param>
        /// <param name="msgbody">Тело сообщения</param>
        void SendHtmlText(string from, IEnumerable<string> recipients, string subject, string msgbody);
    }
