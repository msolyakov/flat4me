...
namespace Flat4Me.Web
{
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            app.CreatePerOwinContext<F4MeWebUserManager>(F4MeWebUserManager.Create);
            app.CreatePerOwinContext<F4MeWebSignInManager>(F4MeWebSignInManager.Create);
            ...
            var cookieProvider = new CookieAuthenticationProvider
            {
                ...
                OnValidateIdentity = SecurityStampValidator.OnValidateIdentity<F4MeWebUserManager, F4MeUser, int>(
