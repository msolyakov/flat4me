...
var F4Me = {
    ...
    makeCheckBoxAsBootstrapYesNo: function (selector, yesPhrase, noPhrase) {
        $(selector).bootstrapSwitch("destroy");
        $(selector).bootstrapSwitch({
            onColor: "success",
            onText: yesPhrase || "Да",
            offText: noPhrase || "Нет"
        });
    },
    ...
    makeAllCheckBoxAsBootstrapPhrases: function (yesPhrase, noPhrase) {
        this.makeCheckBoxAsBootstrapYesNo('input[type=checkbox]', yesPhrase, noPhrase);
    },
